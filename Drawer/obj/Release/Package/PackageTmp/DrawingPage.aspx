    ...
    <form id="form1" runat="server">
        <div class="top">
            <a href="#" data-toggle="modal" data-target="#modalNew">
                <img src="imgs/default.png" alt="Undo" style="margin-left: 15px; width: 40px; height: 40px" /></a>
            ...
            <a href="#" data-toggle="modal" data-target="#modalUndo">
                <img src="imgs/Undo-icon.png" alt="Undo" style="margin-left: 25px; width: 40px; height: 40px" /></a>
            <a href="#" data-toggle="modal" data-target="#modalRedo">
                <img src="imgs/Redo-icon.png" alt="Undo" style="margin-left: 25px; width: 40px; height: 40px" /></a>
            <a href="#" data-toggle="modal" data-target="#modalQuery">
                <img src="imgs/query.png" alt="Undo" style="margin-left: 25px; width: 40px; height: 40px" /></a>
            <a href="#" data-toggle="modal" data-target="#modalHelp">
                <img src="imgs/FAQ.png" alt="Undo" style="margin-left: 25px; width: 40px; height: 40px" /></a>
        </div>
                                ...
                                <div class="tab-pane" id="DeleteWeakEntity">
                                    <div class="form" role="form">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="DropDownList2" name="attributeEntity" runat="server" CssClass="form-control">
                                                <asp:ListItem Text="-- Select Entity --" />
                                            </asp:DropDownList>
                                        </div>
                                        <div class="form-group">
                                            <asp:Button ID="Button22" Text="Delete" runat="server" CssClass="btn btn-default" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="tab-pane active" id="UpdateAttribute">
                                    <div class="form" role="form">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlEditAttributeSelectAttribute" name="editEntity" AppendDataBoundItems="true" runat="server" CssClass="form-control">                                              
                                                <asp:ListItem Text="-- Select Entity --" />
                                            </asp:DropDownList>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="tab-pane" id="DeleteDrivedAttribute">
                                    <div class="form" role="form">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="DropDownList4" name="attributeEntity" runat="server" CssClass="form-control">
                                                <asp:ListItem Text="-- Select Entity --" />
                                            </asp:DropDownList>
                                        </div>
                                        <div class="form-group">
                                            <asp:Button ID="Button24" Text="Delete" runat="server" CssClass="btn btn-default" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="tab-pane active" id="CompositeAttribute">
                                    <div class="form" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlCreateCompositeAttributeEntity" name="attributeEntity" runat="server" CssClass="form-control">
                                                <asp:ListItem Text="-- Select Entity --" />
                                            </asp:DropDownList>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="DeleteMultiValuedAttribute">
                                    <div class="form" role="form">
                                        <div class="form-group">
                                            <label for="attributeEntity">Select Attribute:</label>
                                            <asp:DropDownList ID="DropDownList5" name="attributeEntity" runat="server" CssClass="form-control">
                                                <asp:ListItem Text="-- Select Attribute --" />
                                            </asp:DropDownList>
                                        </div>
                                        <div class="form-group">
                                            <asp:Button ID="Button26" Text="Delete" runat="server" CssClass="btn btn-default" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        <div class="form" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlRelationshipType" name="relationshipType" runat="server" CssClass="form-control">
                    ...
                    <div class="modal-body">
                        <div class="form" role="form">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlEditRelationshipSelect" name="editEntity" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlEditEntitySelect_SelectedIndexChanged">
                                    <asp:ListItem Text="-- Select Entity --" />
                                </asp:DropDownList>
                            </div>
                            <div class="form-group">
